...
<xsl:template match="/atom:feed">
	...
	<link rel="icon" sizes="32x32" href="http://localhost:4000/assets/img/">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000">  <img src="/assets/img/logo_notext.png" style="width:30px"/> AKBC 2019</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="right">
              ...
              <li class="divider"></li>
              <li><a  href="http://localhost:4000/sponsors/">Sponsors</a></li>
              ...
              <li class="divider"></li>
              <li><a  href="http://localhost:4000/#dates">Dates</a></li>
              ...
              <li class="divider"></li>
              <li><a  href="http://localhost:4000/organization/">Organization</a></li>
      ...
      <ul class="left">
              ...
              <li><a  href="http://localhost:4000/cfp/">Call for papers</a></li>
              <li class="divider"></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000">Program</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/speakers/">Speakers</a></li>
                      ...
                      <li><a  href="http://localhost:4000/workshops/">Accepted papers</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000">Information for participants</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/venue/">Venue</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/registration/#visa">Visa information</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/travel/">Travel</a></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="AKBC 2019 – ">
				<img src="http://localhost:4000/assets/img/logo.png" alt="AKBC 2019 – " width="100px">
			</a>
